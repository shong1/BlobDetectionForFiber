...
//	realWriter->Update();
	...
	{
		kMeanArr->SetValue( 0, vecMean.at( i ) );
	...
	kMean->SetAssessOption( false );
	kMean->SetLearnOption( true );
	kMean->SetDeriveOption( true );
	kMean->SetTestOption( false );
	kMean->SetDefaultNumberOfClusters( 2 );
	kMean->Update();
